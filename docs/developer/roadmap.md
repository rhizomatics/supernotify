...
v2.10.0 shipped a first beta, see [Assist and AI Agents](../usage/assist.md). It's all switched on in the options, on the **Assist and AI agents (beta)** page, and off by default.
