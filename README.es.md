...
>> Ahora también está disponible una acción alternativa `supernotify.notify`, mucho más fácil de configurar desde automatizaciones, que funciona de forma idéntica a las acciones existentes.
...
![Ejemplo de acción de notificación](https://supernotify.rhizomatics.org.uk/dev/assets/images/notification.png){width=500}
...
- **Los enlaces (Links)** se pueden configurar, pero actualmente no se utilizan.
- YAML sigue siendo necesario para Entregas, Transportes, Destinatarios, Acciones, etc.
