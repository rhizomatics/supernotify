...
1. Switch entities continue as they are with delivery and transport

   `switch.transport_email` switches off all email deliveries, including the default `switch.delivery_email` switches off only the default delivery. For most people, these will equivalent, if they have 0 or 1 explicitly configured deliveries
