...
>> दोनों ही स्थितियों में, कुछ भी हटाया या कमेंट आउट नहीं किया जाएगा, इसलिए परिवर्तन को वापस लाना आसान होगा। जब आपको यकीन हो जाए कि नया संस्करण आपके लिए काम कर रहा है, तो पुराना कॉन्फ़िगरेशन हटा दें। इससे लॉग में दिखने वाली `[homeassistant.components.notify] Failed to initialize notification service supernotify` चेतावनी भी हट जाएगी, जो पुराने notify कार्यान्वयन से आती है।

>> अब एक वैकल्पिक `supernotify.notify` क्रिया भी उपलब्ध है, जिसे स्वचालन से कॉन्फ़िगर करना कहीं अधिक आसान है, और यह मौजूदा क्रियाओं की तरह ही काम करती है।
...
![उदाहरण सूचना कार्रवाई](https://supernotify.rhizomatics.org.uk/dev/assets/images/notification.png){width=500}
...
- **लिंक** कॉन्फ़िगर किए जा सकते हैं लेकिन वर्तमान में उपयोग में नहीं हैं।
- डिलीवरी, ट्रांसपोर्ट, प्राप्तकर्ता, क्रिया आदि के लिए अभी भी YAML आवश्यक है
