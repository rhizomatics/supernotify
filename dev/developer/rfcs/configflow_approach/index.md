...
1. Advanced and Less Clear HA Construct
...
1. More obscure, less benefit from being in UI
...
- Move Delivery, Transport, Recipient and Camera to ConfigFlow, following the design in [Deliveries and Transports](https://supernotify.rhizomatics.org.uk/latest/developer/rfcs/deliveries_and_transports/index.md).
