...
Separate custom component on HACS, per package, as Supernotify "plugins". More noticeable, e.g. someone looking for help with Frigate more likely to pick a Frigate Supernotify plugin from HACS than examine Supernotify and find the small print.
