...
See the core [AWS Integration](https://www.home-assistant.io/integrations/aws/) for how to use notify to send messages to AWS Lambda, SNS, SQS and EventBridge.
